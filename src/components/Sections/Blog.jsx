...
function Blog() {
  return (
    <div className=" p-4 md:p-10 lg:px-14  bg-section-1 Nalist-font-family">
      <div className="flex justify-center items-center ">
        <div className="flex-col flex justify-center ">
          {length.map(() => {
            return (
              <svg
                className="pt-[1px] md:w-fit w-14"
        ...
        <div className="flex-col flex justify-center ">
          {length.map(() => {
            return (
              <svg
                className="pt-[1px] w-14 md:w-fit"
                xmlns="http://www.w3.org/2000/svg"
                width="70"
                height="4"
                viewBox="0 0 70 2"
      ...
      <div className="grid gap-6 lg:gap-8 pt-9 grid-cols-1 md:grid-cols-3">
        {BlogData.map((item) => {
          return (
            <div className="flex flex-col h-fit p-5 section-2-bg rounded-2xl">
              ...
              <div className="flex flex-col">
                <h2 className="text-xl h-14 font-semibold pt-1 overflow-hidden  text-white">{item.title}</h2>
      ...
      <div className="pt-2">
        <button className="flex md:hidden navabr-gold-btn-border py-2 w-full justify-center">
          <span className="text-gold text-xl">Read more</span></button>
      </div>
    </div>
  );
}
