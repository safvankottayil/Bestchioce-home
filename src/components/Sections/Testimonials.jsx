...
function Testimonials() {
  return (
    <>
    <div className=' px-4 md:p-16 bg-section-1 Nalist-font-family'>
      <div className='grid grid-cols-4 gap-2 md:gap-6'>
        {item.map((value)=>{
            return(<div className='h-fit md:h-36 flex flex-col items-center justify-center p-4 service-card '>
                      ...
                      <p className='text-gray-900 Nalist-font-family  whitespace-nowrap  font-normal text-base md:text-2xl'>{value.item}</p>
            </div>)
        })}
      </div>
    </div>
    ...
    <div className='md:p-16 p-4 pt-12 md:pt-0  bg-section-1'>
        ...
        <h1 className='flex px-8 text-4xl text-gold Nalist-font-family font-black'>Testimonial</h1>
        <div className="flex-col flex justify-center ">
          {length.map(() => {
            return (
              <svg
        ...
        {/* data */}
        <div  className='grid grid-cols-1 md:grid-cols-3  gap-9 pt-9 Nalist-font-family '>
            {testimonialData.map((item)=>{
                return(<div className='flex flex-col h-60 p-8 service-card'>
